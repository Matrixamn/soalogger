...
# Set up BEA Home
BEA_HOME="/opt/app/oracle/Middleware"

# Set up Middleware Home
MW_HOME="/opt/app/oracle/Middleware"

# Set up WebLogic Home
WL_HOME="/opt/app/oracle/Middleware/wlserver_10.3"

# Set up Common Modules Directory
MODULES_DIR="/opt/app/oracle/Middleware/modules"

# Set up Common Features Directory
FEATURES_DIR="/opt/app/oracle/Middleware/modules/features"
...
export BEA_HOME MW_HOME WL_HOME MODULES_DIR FEATURES_DIR ANT_HOME ANT_CONTRIB JAVA_HOME JAVA_VENDOR PRODUCTION_MODE JAVA_USE_64BIT
...
WEBLOGIC_CLASSPATH="${JAVA_HOME}/lib/tools.jar${CLASSPATHSEP}${WL_HOME}/server/lib/weblogic_sp.jar${CLASSPATHSEP}${WL_HOME}/server/lib/weblogic.jar${CLASSPATHSEP}${FEATURES_DIR}/weblogic.server.modules_10.3.3.0.jar${CLASSPATHSEP}${WL_HOME}/server/lib/webservices.jar${CLASSPATHSEP}${ANT_HOME}/lib/ant-all.jar${CLASSPATHSEP}${ANT_CONTRIB}/lib/ant-contrib.jar${CLASSPATHSEP}${WL_HOME}/server/lib/com.ibm.mq.jar${CLASSPATHSEP}${WL_HOME}/server/lib/postgresql-9.0-801.jdbc4.jar"
export WEBLOGIC_CLASSPATH

# set up config tools class path 
FMWCONFIG_CLASSPATH="${JAVA_HOME}/lib/tools.jar${CLASSPATHSEP}${BEA_HOME}/utils/config/10.3/config-launch.jar${CLASSPATHSEP}${WL_HOME}/server/lib/weblogic_sp.jar${CLASSPATHSEP}${WL_HOME}/server/lib/weblogic.jar${CLASSPATHSEP}${FEATURES_DIR}/weblogic.server.modules_10.3.3.0.jar${CLASSPATHSEP}${WL_HOME}/server/lib/webservices.jar${CLASSPATHSEP}${ANT_HOME}/lib/ant-all.jar${CLASSPATHSEP}${ANT_CONTRIB}/lib/ant-contrib.jar"
